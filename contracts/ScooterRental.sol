...
contract ScooterRental {
    ...
    address owner;
    uint ownerBalance;
    event DepositSuccess(address owner);
    ...
    function checkIn(address walletAddress) public isRenter(walletAddress) {
        require(renters[walletAddress].active == true, "Please check out a scooter first.");
    ...
    function canRentScooter(address walletAddress) public isRenter(walletAddress) view returns(bool) {
